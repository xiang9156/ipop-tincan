...
LDIR = -L./lib
LIBS = -lipoptap -lrtc_p2p -lrtc_base -ljsoncpp -lrtc_base_approved -lrtc_xmpp -lrtc_xmllite -lpthread -lfield_trial_default -lexpat -lboringssl -lrt -lboringssl_asm
ODIR=obj
SRCDIR=src
